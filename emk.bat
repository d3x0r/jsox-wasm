...
:--pre-js or --post-js
call emcc -O2 -s WASM=1 -o ./jsox-w.js -std=c++11 --bind -Wno-address-of-packed-member -Wno-parentheses -Wno-comment -Wno-null-dereference -D__LINUX__ -s RESERVED_FUNCTION_POINTERS=20  jsox.cc emscripten_bindings.cc --post-js jsoxParse.js
