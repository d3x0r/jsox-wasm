	...
	return EM_ASM_INT( (
		...
		for( n = 0; n < $4; n++ ) {
			...
			if( index <	 0 )
				...
				index = UTF8ToString( stringArr[index*2+0], stringArr[index*2+1] );
			}
			...
			case 3: // FALSE
				...
				break;
			case 4: // STRING
				o[index] = UTF8ToString( stringArr[mapArr[n*4+3]*2+0], stringArr[mapArr[n*4+3]*2+1] );
				break;
			case 5: // NUMBER
				{
			...
			case 11: // Infinity
				...
				break;
			case 12: // Date
				o[index] = new Date( UTF8ToString( stringArr[mapArr[n*4+3]*2+0], stringArr[mapArr[n*4+3]*2+1] ) );
				break;
			case 13: // BigInt
				o[index] = BigInt( UTF8ToString( stringArr[mapArr[n*4+3]*2+0], stringArr[mapArr[n*4+3]*2+1] ) );
				break;
			case 14: // EMPTY
				o[index] = undefined;
				delete o[index];
